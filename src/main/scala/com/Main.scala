...
object Main {
  def main(args: Array[String]) {
    ...
    def comGit: Unit = {
      ...
      val ht = new httpTest
      val content = ht.httpGet("http://www.landchina.com/default.aspx?tabid=386&comname=default&wmguid=75c72564-ffd9-426a-954b-8ac2df0903b7&recorderguid=9595ee03-2952-430a-8466-ab0179ad1687", unit.setheader("www.landchina.com", "http://www.landchina.com/default.aspx?tabid=263"))
      println(content)
