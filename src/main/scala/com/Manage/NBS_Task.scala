...
//    nw2.firstHttpGet("http://data.stats.gov.cn/easyquery.htm?m=QueryData&dbcode=hgyd&rowcode=zb&colcode=sj&wds=%5B%5D&dfwds=%5B%7B%22wdcode%22%3A%22sj%22%2C%22valuecode%22%3A%22199501-201511%22%7D%5D")
//    list.foreach(x => nw2.HttpPost(x))
//  }
//  def NBS_Task1 = {
//    var str2 = ""
...
//    println("分类标签已获取")
//    str2 = ht.httpGet(str)
//    NationalData_WkOther.dataType = "分省年度数据"
//    nw.firstHttpGet("http://data.stats.gov.cn/easyquery.htm?m=QueryData&dbcode=fsnd&rowcode=reg&colcode=sj&wds=%5B%7B%22wdcode%22%3A%22zb%22%2C%22valuecode%22%3A%22A020101%22%7D%5D&dfwds=%5B%7B%22wdcode%22%3A%22sj%22%2C%22valuecode%22%3A%22LAST20%22%7D%5D")
...
//    nw.rowcode="reg"
//    nw.wdcode="reg"
//    nw.uri = "http://data.stats.gov.cn/easyquery.htm?cn=E0104"
//    nw.httpCookie
//    val str = "http://data.stats.gov.cn/easyquery.htm?m=getOtherWds&dbcode=csyd&rowcode=reg&colcode=sj&wds=%5B%5D"
//    val ht = new httpTest
//    println("分类标签已获取")
//    NationalData_WkOther.dataType = "主要城市月度价格"
//    nw.firstHttpGet("http://data.stats.gov.cn/easyquery.htm?m=QueryData&dbcode=csyd&rowcode=reg&colcode=sj&wds=%5B%7B%22wdcode%22%3A%22zb%22%2C%22valuecode%22%3A%22A01010102%22%7D%5D&dfwds=%5B%7B%22wdcode%22%3A%22sj%22%2C%22valuecode%22%3A%22199501-201512%22%7D%5D")
//    nw.addClassifyId(ht.httpGet(str))
//    nw.addClassifyId2(ht.httpGet(str3))
